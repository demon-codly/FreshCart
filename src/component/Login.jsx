...
const Login = () => {
    ...
    return (
        <div onClick={() => setShowUserLogin(false)} className="fixed top-0 bottom-0 left-0 right-0 z-30 flex items-center text-sm text-grey-600 bg-black/50">
            <div className="flex h-[700px] w-full m-auto bg-white rounded-lg shadow-xl overflow-hidden">
                ...
                <div className="w-full flex flex-col items-center justify-center">
                    <form onClick={(e) => e.stopPropagation()} className="md:w-96 w-80 flex flex-col items-center justify-center">
